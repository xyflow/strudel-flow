...
- Hit **+** to add instruments, sounds, and effects.
- Connect their round handles to build a patch.
- Press **Space** to play or pause, and keep tinkering while it loops.
- Use the **folder** to save a patch or grab a link to share.
